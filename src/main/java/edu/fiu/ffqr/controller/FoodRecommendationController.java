...
//            }
    ...
    public static double setCalculatedAmountForBreastMilk(int babyAgeInMonth) {
        ...
        double fiveMonthInfantBreastMilkVolume = 796.0;
        double sixMonthInfantBreastMilkVolume = 854.0;
        double sevenMonthInfantBreastMilkVolume = 867.0;
        double eightMonthInfantBreastMilkVolume = 815.0;
        double nineMonthInfantBreastMilkVolume = 890.0;
        double tenMonthInfantBreastMilkVolume = 900.0;
        double elevenMonthInfantBreastMilkVolume = 910.0;
        double twelveMonthInfantBreastMilkVolume = 900.0;
